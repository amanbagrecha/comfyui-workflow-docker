...
- `SEAM_WIDTH` (default: `16`; half-width in pixels of the panorama seam inpaint strip)
- `SEAM_FEATHER` (default: `15`; blend feather radius in pixels at seam strip edges)
- `SEAM_SIGMA` (default: `1.5`; Gaussian blur sigma applied to the seam mask edges)
